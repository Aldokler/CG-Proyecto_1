...
void trasladeMap(int d_x, int d_y){
  ...
  T_puntos_D(puntosHeredia, LEN_HEREDIA, d_x, d_y);
  T_puntos_D(puntosLimon, LEN_LIMON, d_x, d_y);
  T_puntos_D(puntosCartago, LEN_CARTAGO, d_x, d_y);
  T_puntos_D(puntosSanJose, LEN_SANJOSE, d_x, d_y);
  T_puntos_D(puntosAlajuela, LEN_ALAJUELA, d_x, d_y);
  T_puntos_D(puntosGuanacaste, LEN_GUANACASTE, d_x, d_y );
  T_puntos_D(puntosPuntarenas, LEN_PUNTARENAS, d_x, d_y);
  T_puntos_D(puntosPuntarenasB, LEN_PUNTARENASB, d_x, d_y);
...
//}
  ...
  MagickReadImage(magick_wand, "images/hr.avs");
  ...
  MagickReadImage(magick_wand, "images/al.avs");
  ...
  MagickReadImage(magick_wand, "images/ct.avs");
  ...
  MagickReadImage(magick_wand, "images/sj.avs");
  ...
  MagickReadImage(magick_wand, "images/lm.avs");
  ...
  MagickReadImage(magick_wand, "images/gn.avs");
  ...
  MagickReadImage(magick_wand, "images/pt.avs");
